...
class Nets:
    ...
    def compress_routes(self, debug=False, design='', component_list=None, components_lef=None, pin_list=None, report_route=True, subsegment=True):
        ...
        if (self.dangle_routes and subsegment) or len(self.devs) > 2:
